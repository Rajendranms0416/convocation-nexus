...
export const queryDynamicTable = (tableName: string) => {
  // Cast the response as any and then provide better types in the consuming code
  return supabase.from(tableName) as unknown as ReturnType<typeof supabase.from<DynamicTableRow>>;
};
